...
* **Entities** — the objects that you will encounter in the grid
* **Objectives** — what you must accomplish to complete a level
* **Movements** — how the Agent moves and interacts with various objects
